    ...
    >
      <el-form label-width="80px" label-position="left">
        ...
        <el-upload
          ...
          :auto-upload="false"
          :on-change="(file) => handleImgSuccess(file, 'imgsrc')"
        >
          <el-image
            ...
            v-if="imgsrc"
          >
          <!-- :preview-src-list="[user.imgsrc]" 预览-->
          </el-image>
  ...
  methods: {
    ...
    handleImgSuccess(file, type) {
        uploadimgtooss(file).then((res) => {
            console.log(res,`this is upload`)
            this.imgsrc = res;
        })
    },
    close() {
